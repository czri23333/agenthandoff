...
| `qoder-ide` | JSONL dir + SQLite overlays | ✓ | — | — | — | ⚠️ unverified (no fixture) |
| `qwenwork` | JSONL dir | ✓ | 3 | 1 ses / 3 msg | ✓ | ✅ stable (fixture-proven) |
| `workbuddy` | JSONL dir + SQLite overlays | ✓ | — | — | — | ⚠️ unverified (no fixture) |
...
| `qoderwork-cn-app` | SQLite (app data) | ✓ | 2 | 2 ses / 32 msg | ✓ | ✅ stable (fixture-proven) |
| `qwenwork-app` | SQLite (app data) | ✓ | — | — | — | ⚠️ unverified (no fixture) |
| `cherrystudio` | SQLite (app data) | ✓ | 2 | 3 ses / 1816 msg | ✓ | ✅ stable (fixture-proven) |
